...
class QuestionIndexBuilder:
    ...
    taxonomy = [
        ...
        ("AI/RAG", ["rag", "知识库", "bm25", "召回", "重排", "embedding", "向量库", "chunk", "查询改写", "检索增强", "rerank", "混合检索"]),
        ("Agent开发", ["agent", "function calling", "tool calling", "workflow", "multi-agent", "planner", "memory", "智能体", "任务编排", "工具调用", "mcp", "langchain", "langgraph", "multi agent"]),
        ("LLM应用工程", ["ai", "大模型", "大模型应用", "大模型应用开发", "ai应用", "ai应用开发", "prompt", "结构化输出", "模型路由", "模型降级", "token", "评测", "观测", "推理", "ai coding"]),
